...
source_filename = "case\backend_test4_complex.sy"
declare i32 @getint()
...
label_main_ENTRY:
  ...
  br i1 %op23, label %label_if_then, label %label_if_else
...
label_if_else:                                                ; preds = %label_main_ENTRY
  ...
  br i1 %op26, label %label_if_then, label %label_if_else
label_if_then:                                                ; preds = %label_if_else
  store i32 50, i32* %d
  br label %label_if_end
label_if_end:                                                ; preds = %label_if_then, %label_if_else
  ret i32 0
label_if_else:                                                ; preds = %label_if_else
  store i32 0, i32* %d
  br label %label_if_end
}
