...
source_filename = "case\bd_test4_long_expr.sy"
declare i32 @getint()
...
label_if_then_1:                                                ; preds = %label_main_ENTRY
  ...
  br i1 %op26, label %label_if_then_2, label %label_if_end_2
...
label_if_then_2:                                                ; preds = %label_if_then_1
  ...
  br i1 %op30, label %label_if_then_3, label %label_if_end_3
...
label_if_then_3:                                                ; preds = %label_if_then_2
  ...
  br i1 %op33, label %label_if_then_4, label %label_if_end_4
...
label_if_end_4:                                                ; preds = %label_if_then_3, %label_if_then_4
